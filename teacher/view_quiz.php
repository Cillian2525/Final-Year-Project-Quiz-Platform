...
// Security: only teachers may view quizzes from this page
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand d-flex align-items-center gap-2" href="../dashboards/teacher_dashboard.php">
                <img src="../assets/intelliquiz-icon.svg" alt="IntelliQuiz" width="28" height="28" style="display:block;">
                <span>IntelliQuiz</span>
            </a>
            <div class="navbar-nav ms-auto">
                <a class="nav-link" href="manage_quizzes.php" style="color: rgba(255, 255, 255, 0.92) !important;">Manage Quizzes</a>
                <a class="nav-link" href="../dashboards/teacher_dashboard.php" style="color: rgba(255, 255, 255, 0.92) !important;">Dashboard</a>
