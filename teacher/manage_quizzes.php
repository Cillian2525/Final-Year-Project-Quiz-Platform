        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                ...
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 mb-5">View your quizzes and performance statistics</p>
                </div>
            </div>
        </div>
    </header>
    ...
    <section class="page-section" id="quizzes">
        <div class="container px-4 px-lg-5">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mt-0 mb-0">My Quizzes</h2>
                <a href="../dashboards/teacher_dashboard.php" class="btn btn-outline-secondary">Back to dashboard</a>
            </div>
