...
<head>
    ...
    <style>
        ...
        header.masthead {
            background: linear-gradient(135deg, #0d6efd 0%, #6f42c1 50%, #111827 100%);
...
<body>
    ...
    <header class="masthead" style="padding-top: 6rem; padding-bottom: 2rem; min-height: 0;">
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 align-items-center justify-content-center">
                <div class="col-lg-7 text-center text-lg-start">
                    <div class="text-white-75 small mb-2">Adaptive quizzes for Computer Science learning</div>
                    <h1 class="text-white fw-bold display-6 mb-2">IntelliQuiz</h1>
                    <p class="text-white-75 mb-3">
                        A multi-role quiz platform with static quizzes, adaptive difficulty, and optional AI-generated question support.
                    </p>
                    <div class="d-flex flex-column flex-sm-row gap-2">
                        <a class="btn btn-primary px-4 rounded-pill" href="auth/login.php">Get Started</a>
                        <a class="btn btn-outline-light px-4 rounded-pill" href="auth/register.php">Create Account</a>
                    </div>
                </div>
